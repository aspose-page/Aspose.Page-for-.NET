...
namespace Aspose.Page.Live.Demos.UI.Models
{
	...
	public abstract class ModelBase : ApiController
	{
		...
		{
			string sourceFolder = Aspose.Page.Live.Demos.UI.Config.Configuration.WorkingDirectory + folderName;
	  ...
	  bool deleteSourceFolder = true, string zipFileName = null, string WorkingDirectory = null, string OutputDirectory = null)
		{
			...
			{
				WorkingDirectory = Aspose.Page.Live.Demos.UI.Config.Configuration.WorkingDirectory;
			}
			if (OutputDirectory == null)
			{
				OutputDirectory = Aspose.Page.Live.Demos.UI.Config.Configuration.OutputDirectory;
			}
