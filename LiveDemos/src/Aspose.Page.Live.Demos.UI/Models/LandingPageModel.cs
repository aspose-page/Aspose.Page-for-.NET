...
using Aspose.Page.Live.Demos.UI.Controllers;
...
namespace Aspose.Page.Live.Demos.UI.Models
{
	public class LandingPageModel
	{
		...
		public AsposePageContext AsposePageContext
		{
			get
			{
				if (_atcContext == null) _atcContext = new AsposePageContext(HttpContext.Current);
				return _atcContext;
			}
		}
		...
		public string UIBasePath => Configuration.AsposePageLiveDemosPath;
